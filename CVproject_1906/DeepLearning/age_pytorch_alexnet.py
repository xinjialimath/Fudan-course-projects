...
#            lr1 = lr1 * 0.9
#            lr2 = lr2 * 0.9
            savepath='face_code/mymodel/age_model_alexnet_' + str(epoch) +'.pkl'
...
torch.save(trained_model,'face_code/mymodel/age_model_alexnet_final.pkl')
file=open('face_code/mymodel/alexnet_accuracy.txt','w')
file.write(str(Accuracy_list))
file.close()
file2=open('face_code/mymodel/age_alexnet_loss.txt','w')
...
plt.show()
plt.savefig("face_code/results/age_alexnet_train_accuracy_loss_v0.jpg")
