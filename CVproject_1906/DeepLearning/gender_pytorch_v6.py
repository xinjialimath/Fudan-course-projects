...
#            lr1 = lr1 * 0.9
#            lr2 = lr2 * 0.9
            savepath='face_code/mymodel/model_v6_' + str(epoch) +'.pkl'
...
torch.save(trained_model,'face_code/mymodel/model_v6_final.pkl')
file=open('face_code/mymodel/v6_accuracy.txt','w')
file.write(str(Accuracy_list))
file.close()
file2=open('face_code/mymodel/v6_loss.txt','w')
...
plt.show()
plt.savefig("face_code/results/train_accuracy_loss_v6.jpg")
