...
model = torch.load('/home/lixj/face_code/mymodel/age_all/age_model_v0.pkl')
...
def test(model, testloader):
    ...
    #file=open('face_code/results/v0_raw_Lab.txt','w')
    #file.write(str(Lab))
    #file.close()
    #file=open('face_code/results/v0_raw_prediction.txt','w')
    #file.write(str(Pre))
